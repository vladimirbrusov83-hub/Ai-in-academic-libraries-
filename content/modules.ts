...
In order to develop genuine judgment about tool selection, I recommend deliberately varying the tools one uses for low stakes tasks over a period of several weeks, noting where each tool's outputs differ meaningfully, and building that experiential knowledge before applying it to higher stakes professional work. Such deliberate practice is the most reliable path to tool discernment, the kind of calibrated, task specific judgment that ACRL subcompetencies 3.4 and 4.5 describe as the professional standard.`,
        },
      ],
      practitionerNote:
...

  {
    ...
    content: {
      intro:
        "The first time I read the ACRL AI Competencies document, I was struck by how much of it was about caution. Not fear, but caution. There's a difference. This module is about developing the professional judgment to use AI in ways that serve your patrons and uphold your values.",
      sections: [
        {
...
The documentation step is where sustainable workflow development most often breaks down. A workflow that works for one person and has never been written down is not an institutional workflow; it is a personal practice that disappears when the person changes roles or institutions. In order to build a workflow that persists and can be handed off, the documentation should capture the prompt or prompt template used, the quality review criteria applied, the record keeping conventions for flagging AI assisted records, and the conditions under which the workflow requires escalation to additional professional review. Such documentation is the difference between AI adoption that builds institutional capacity and AI adoption that builds individual efficiency, and for digital collections programs managing long term collections, institutional capacity is the appropriate goal. Furthermore, sharing workflow documentation with peer institutions through professional networks such as the Digital Library Federation, the Society of American Archivists, and OCLC communities, contributes to the shared professional knowledge base that makes adoption easier for institutions earlier in the process.`,
      ...
      practitionerNote:
        "The accessibility application is what convinced me that AI belongs in digital collections workflows, not as a productivity enhancement but as a genuine service expansion. I was looking at an oral history collection with over sixty recordings and no transcripts, knowing that manual transcription was financially out of reach and that we had been carrying that accessibility debt for years. Running the first ten interviews through Whisper and reviewing the output took me an afternoon. The transcripts were not perfect. There were proper noun errors, some regional vocabulary the model did not recognize, and a few passages that needed significant correction. But they were usable after review, and they were better than no transcript, and they were done. What struck me was not the efficiency, though the efficiency is real. It was that the barrier between 'this collection exists' and 'this collection is accessible' had dropped low enough to actually cross. That is a different category of value than saving time on a task I was already doing.",
      summary: [
